...
与 [README.md](README.md) 对齐的当前实现说明（**v0.1.6**）。
...
| `CLIENT_LATEST_VERSION` | `0.1.6` | 客户端版本号（更新检查） |
...
- 下载：[GitHub Releases v0.1.6](https://github.com/gsvps/cloud-desk/releases/tag/v0.1.6)（`latest` 始终指向最新）
- 三栏 UI：本机 / 设置 / 远程控制
